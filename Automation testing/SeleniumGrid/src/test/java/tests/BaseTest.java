...
public class BaseTest {
    ...
    private static final String CANADIAN_TIRE_URL = "https://www.evo.com/";
    ...
    public SignInPOPUP getSignInPopUP(){return new SignInPOPUP(getDriver()); }

    public SnowBoardPage getSNBPage(){ return new SnowBoardPage(getDriver()); }

    public SNBBindingsPage getSNBBindingsPage(){ return new SNBBindingsPage(getDriver()); }
